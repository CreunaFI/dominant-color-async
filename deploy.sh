...
rsync -av --progress dominant-color-async/ dominant-color-async-packagist-release/ --exclude .git --exclude node_modules --exclude dominant-color-async.zip --exclude vendor
